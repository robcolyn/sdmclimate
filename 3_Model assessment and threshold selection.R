...
#the circular window method (see SDM script) is a good method of generating constrained 
#background points if no absence data is available.
...
par(mfrow=c(1,1)) #amend as required
for(i in 1:3)
...
#validation. Substitute presence points to only include validation
#data. Assess ommision rates, AUC-ROC plots and histograms of predicted 
#suitability. 
